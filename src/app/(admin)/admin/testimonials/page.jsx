                        ...
                        <div className="max-w-7xl mx-auto">
                            ...
                            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-gray-500">Manage, edit, and create new testimonials.</p>
                                </div>
                                <a
                                ...
                                <div className="overflow-x-auto">
                                    <table className="w-full text-sm text-left text-gray-500">
                                        <thead className="text-xs text-gray-700 uppercase bg-gray-50">
                                            <tr>
                                                <th scope="col" className="px-6 py-3 min-w-[250px]">Name</th>
                                        ...
                                        <tbody>
                                            {testimonials.map((test) => (
                                                <tr key={test.id} className="bg-white hover:bg-gray-50 transition-colors duration-200">
                                                    <td className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">{test.person_name}</td>
                                                    <td className="px-6 py-4">{test.person_institution}</td>
                                                    <td className="px-6 py-4">{formatDate(test.created_at)}</td>
                                                    <td className="px-6 py-4">
                                                        <div className="flex items-center justify-center space-x-3">
                                                            <button onClick={() => handleView(test.id)} className="text-gray-500 hover:text-blue-600" title="View">
                                                                <Icon path={ICONS.view} />
                                                            </button>
                                                            <button onClick={() => handleEdit(test.id)} className="text-gray-500 hover:text-green-600" title="Edit">
                                                                <Icon path={ICONS.edit} />
                                                            </button>
                                                            <button onClick={() => handleDelete(test.id)} className="text-gray-500 hover:text-red-600" title="Delete">
