...
export default function CreatePopupBannerPage() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setSubmissionStatus({ message: "Submitting popup banner...", type: "info" });
    ...
    try {
      ...
      if (imageFile) {
        const filePath = `popup/${Date.now()}-${imageFile.name}`;
      ...
      if (mobileImageFile) {
        const filePath = `popup/mobile-${Date.now()}-${mobileImageFile.name}`;
      ...
      console.error("❌ Error creating popup banner:", err);
        ...
        >
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Fill out the details below to create a new popup banner.
            </p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="Popup banner title"
            />
          </div>
                ...
                {mobileImagePreview ? (
                  <div className="relative">
                    <img
                      ...
                      alt="Mobile popup banner preview"
                      className="mx-auto h-32 w-auto object-cover rounded-md"
                    />
                    <button
                      type="button"
